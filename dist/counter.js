...
function App() {
  ...
  const [count, setCount] = (0, import_react18.useState)(toolData?.initialCount ?? 0);
  return /* @__PURE__ */ (0, import_jsx_runtime757.jsxs)("div", { className: "flex flex-col gap-4 p-4 max-w-lg mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_runtime757.jsx)("h1", { className: "text-2xl font-bold", children: "Counter App" }),
    /* @__PURE__ */ (0, import_jsx_runtime757.jsx)("div", { className: "text-6xl font-bold text-center", children: count }),
    /* @__PURE__ */ (0, import_jsx_runtime757.jsxs)("div", { className: "flex gap-2", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(Button, { onClick: () => setCount(count + 1), color: "primary", children: "Increment" })
    ] })
  ] });
}
