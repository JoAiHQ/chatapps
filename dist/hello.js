...
@layer components {
  ...
  .Alert_Alert:where([data-actions-placement=bottom]) {
    align-items: flex-start;
  }
  .Alert_Alert[data-variant=soft] {
    background-color: var(--alert-background-color);
    box-shadow: 0 0 0 1px var(--alert-border-color) inset;
    color: var(--alert-text-color);
  }
  .Alert_Alert[data-variant=soft]:where([data-color=primary]) {
  ...
  .Alert_Alert[data-variant=soft]:where([data-color=success]) {
  ...
  .Alert_Alert[data-variant=soft]:where([data-color=warning]) {
  ...
  .Alert_Alert[data-variant=soft]:where([data-color=caution]) {
  ...
  .Alert_Alert[data-variant=soft]:where([data-color=danger]) {
  ...
  .Alert_Alert[data-variant=soft]:where([data-color=info]) {
  ...
  .Alert_Alert[data-variant=soft]:where([data-color=discovery]) {
  ...
  :where(.Alert_Alert[data-actions-placement=bottom]) .Alert_Content {
    display: block;
  }
  .Alert_Indicator svg {
  ...
  :where(.Alert_Alert[data-actions-placement=end]) .Alert_Actions {
    align-self: center;
    margin-left: var(--alert-gutter);
  }
  :where(.Alert_Alert[data-actions-placement=bottom]) .Alert_Actions {
...
@layer components {
  .Textarea_Container {
    ...
    --textarea-min-height: calc( (var(--textarea-gutter-y) * 2) + (var(--textarea-line-height) * var(--textarea-min-rows)) );
    --textarea-max-height: calc( (var(--textarea-gutter-y) * 2) + (var(--textarea-line-height) * var(--textarea-max-rows)) );
  }
  .Textarea_Container:where([data-size="3xs"]) {
  ...
  .Textarea_Container:where([data-size="2xl"]) {
    --textarea-base-height: var(--control-size-2xl);
    --textarea-font-size: var(--control-font-size-lg);
    --textarea-radius: var(--control-radius-xl);
    --textarea-gutter-x: var(--control-gutter-xl);
  }
  .Textarea_Container:where([data-size="3xl"]) {
    --textarea-base-height: var(--control-size-3xl);
    --textarea-font-size: var(--control-font-size-lg);
    --textarea-radius: var(--control-radius-xl);
    --textarea-gutter-x: var(--control-gutter-xl);
  }
  .Textarea_Container:where([data-gutter-size="2xs"]) {
    --textarea-gutter-x: var(--control-gutter-2xs);
  }
  .Textarea_Container:where([data-gutter-size=xs]) {
    --textarea-gutter-x: var(--control-gutter-xs);
  }
  .Textarea_Container:where([data-gutter-size=sm]) {
    --textarea-gutter-x: var(--control-gutter-sm);
  }
  .Textarea_Container:where([data-gutter-size=md]) {
    --textarea-gutter-x: var(--control-gutter-md);
  }
  .Textarea_Container:where([data-gutter-size=lg]) {
    --textarea-gutter-x: var(--control-gutter-lg);
  }
  .Textarea_Container:where([data-gutter-size=xl]) {
    --textarea-gutter-x: var(--control-gutter-xl);
  }
  .Textarea_Container {
    position: relative;
  ...
  .Textarea_Container:where([data-variant=outline]) {
    box-shadow: 0 0 0 1px var(--input-outline-border-color) inset;
  }
  @media (hover: hover) and (pointer: fine) {
    .Textarea_Container:where([data-variant=outline]):not([data-disabled]):hover {
      box-shadow: 0 0 0 1px var(--input-outline-border-color-hover) inset;
    }
  }
  .Textarea_Container:where([data-variant=outline]):not([data-disabled])[data-focused=true] {
    box-shadow: 0 0 0 1px var(--input-outline-border-color-focus) inset;
  }
  .Textarea_Container:where([data-variant=outline]):not([data-disabled])[data-invalid] {
    box-shadow: 0 0 0 1px var(--input-border-color-invalid) inset;
  }
  .Textarea_Container:where([data-variant=soft]) {
    background-color: var(--input-soft-background-color);
  }
  .Textarea_Container:where([data-variant=soft]):not([data-disabled])[data-focused=true] {
    box-shadow: 0 0 0 1px var(--input-soft-border-color-focus) inset;
  }
  .Textarea_Container:where([data-variant=soft]):not([data-disabled])[data-invalid] {
    box-shadow: 0 0 0 1px var(--input-border-color-invalid) inset;
  }
  .Textarea_Container[data-invalid] ::-moz-selection {
    background-color: var(--red-a50);
  }
  .Textarea_Container[data-invalid] ::selection {
    background-color: var(--red-a50);
  }
  .Textarea_Container[data-disabled] {
    cursor: not-allowed;
    opacity: 0.5;
  }
  .Textarea_Textarea {
  ...
  .Textarea_Textarea::-moz-placeholder {
  ...
  .Textarea_Textarea:-webkit-autofill {
    animation: Textarea_native-autofill-in 1ms;
  }
  .Textarea_Textarea:-webkit-autofill,
  .Textarea_Textarea:-webkit-autofill:focus,
  .Textarea_Textarea:-webkit-autofill:hover {
  ...
  .Textarea_Textarea:-webkit-autofill-and-obscured,
  .Textarea_Textarea:-webkit-autofill-strong-password,
  .Textarea_Textarea:-webkit-autofill-strong-password-viewable {
    color: var(--color-text) !important;
    -webkit-text-fill-color: var(--color-text) !important;
    -webkit-transition:
      background-color 0s 50000s,
  ...
  .Textarea_Textarea:-webkit-autofill::first-line {
    font-size: 16px !important;
    -webkit-transition: font-size 0s 50000s !important;
    transition: font-size 0s 50000s !important;
  }
  .Textarea_Textarea::-webkit-resizer {
    visibility: hidden;
  }
  @keyframes Textarea_native-autofill-in {
    0% {
      opacity: 1;
    }
    100% {
...
// src/apps/hello/index.tsx
var import_react18 = __toESM(require_react(), 1);
var import_client = __toESM(require_client(), 1);

// node_modules/@openai/apps-sdk-ui/dist/es/components/Alert/Alert.js
...
var CheckCircle = (props) => (0, import_jsx_runtime117.jsx)("svg", { width: "1em", height: "1em", viewBox: "0 0 24 24", fill: "currentColor", ...props, children: (0, import_jsx_runtime117.jsx)("path", { d: "M12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4ZM2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12ZM16.0755 7.93219C16.5272 8.25003 16.6356 8.87383 16.3178 9.32549L11.5678 16.0755C11.3931 16.3237 11.1152 16.4792 10.8123 16.4981C10.5093 16.517 10.2142 16.3973 10.0101 16.1727L7.51006 13.4227C7.13855 13.014 7.16867 12.3816 7.57733 12.0101C7.98598 11.6386 8.61843 11.6687 8.98994 12.0773L10.6504 13.9039L14.6822 8.17451C15 7.72284 15.6238 7.61436 16.0755 7.93219Z", fill: "currentColor" }) });
...
var Info = (props) => (0, import_jsx_runtime341.jsxs)("svg", { width: "1em", height: "1em", viewBox: "0 0 24 24", fill: "currentColor", ...props, children: [(0, import_jsx_runtime341.jsx)("path", { d: "M13 12a1 1 0 1 0-2 0v4a1 1 0 1 0 2 0v-4Zm-1-2.5A1.25 1.25 0 1 0 12 7a1.25 1.25 0 0 0 0 2.5Z" }), (0, import_jsx_runtime341.jsx)("path", { fillRule: "evenodd", d: "M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2ZM4 12a8 8 0 1 1 16 0 8 8 0 0 1-16 0Z", clipRule: "evenodd" })] });
...
// node_modules/@openai/apps-sdk-ui/dist/es/components/Alert/Alert.module.css
var Alert_default = {
  Alert: "Alert_Alert",
...
// node_modules/@openai/apps-sdk-ui/dist/es/components/Alert/Alert.js
var Alert = ({ color = "primary", variant = "outline", title, description, actions, actionsPlacement, indicator, className, actionsClassName, ref, ...restProps }) => {
  const containerRef = (0, import_react2.useRef)(null);
  const actionsRef = (0, import_react2.useRef)(null);
  const [actionsAutoPlacement, setActionsAutoPlacement] = (0, import_react2.useState)("end");
  ...
  return (0, import_jsx_runtime746.jsxs)("div", { ref: o([ref, containerRef]), className: clsx_default(Alert_default.Alert, className), "data-variant": variant, "data-color": color, role: color === "danger" ? "alert" : void 0, "data-actions-placement": actionsPlacement ?? actionsAutoPlacement, ...restProps, children: [indicator === false ? null : (0, import_jsx_runtime746.jsx)("div", { className: Alert_default.Indicator, children: indicator ?? (0, import_jsx_runtime746.jsx)(Indicator, { color }) }), (0, import_jsx_runtime746.jsxs)("div", { className: Alert_default.Content, children: [(0, import_jsx_runtime746.jsxs)("div", { className: Alert_default.Message, children: [title && (0, import_jsx_runtime746.jsx)("div", { className: Alert_default.Title, children: title }), description && (0, import_jsx_runtime746.jsx)("div", { className: Alert_default.Description, children: description })] }), actions && (0, import_jsx_runtime746.jsx)("div", { className: clsx_default(Alert_default.Actions, actionsClassName), ref: actionsRef, children: actions })] })] });
};
var Indicator = ({ color }) => {
  switch (color) {
    case "warning":
    case "caution":
    case "danger":
      return (0, import_jsx_runtime746.jsx)(Warning_default, {});
    case "success":
      return (0, import_jsx_runtime746.jsx)(CheckCircle_default, {});
    default:
      return (0, import_jsx_runtime746.jsx)(Info_default, {});
  }
};
...
var flattenTextNodes = (children) => {
  const nodes = import_react4.Children.toArray(children);
  const result = [];
  let buffer = "";
  const flush = () => {
    if (buffer !== "") {
...
var wrapTextNodeSiblings = (children) => {
  ...
  const childrenCount = import_react4.Children.count(flattenedChildren);
  return import_react4.Children.map(flattenedChildren, (child) => {
    if (typeof child === "string" && !!child.trim()) {
      if (childrenCount <= 1) {
        return child;
      }
      return (0, import_jsx_runtime747.jsx)("span", { children: child });
    }
    if ((0, import_react4.isValidElement)(child)) {
      const element = child;
      const { children: innerChildren, ...restProps } = element.props;
      if (innerChildren != null) {
        return (0, import_react4.cloneElement)(element, restProps, wrapTextNodeSiblings(innerChildren));
      }
      return element;
    }
    return child;
...
var AppsSDKUIContext = (0, import_react5.createContext)(null);
...
var LoadingIndicator = ({ className, size, strokeWidth, style, ...restProps }) => {
  return (0, import_jsx_runtime750.jsx)("div", { ...restProps, className: clsx_default(LoadingIndicator_default.LoadingIndicator, className), style: style || toCssVariables({
    "indicator-size": size,
...
var useChildCallback = (cb) => {
  const ref = (0, import_react9.useRef)(cb);
  ref.current = cb;
  return (0, import_react9.useCallback)((element) => ref.current(element), []);
};
...
var TransitionGroupChildInner = ({ ref: forwardedRef, as: TagName, children, className, transitionId, style, preventMountTransition, shouldRender, enterDuration, exitDuration, removeChild, onEnter, onEnterActive, onEnterComplete, onExit, onExitActive, onExitComplete }) => {
  const [state, dispatch] = (0, import_react10.useReducer)(transitionReducer, getInitialTransitionState(preventMountTransition || false));
  const preventedMountTransition = (0, import_react10.useRef)(false);
  const elementRef = (0, import_react10.useRef)(null);
  const enterDurationRef = (0, import_react10.useRef)(enterDuration);
  enterDurationRef.current = enterDuration;
  const exitDurationRef = (0, import_react10.useRef)(exitDuration);
  exitDurationRef.current = exitDuration;
  const lastCallbackRef = (0, import_react10.useRef)(null);
  const triggerCallback = (0, import_react10.useCallback)((callbackType) => {
  ...
  return (0, import_jsx_runtime751.jsx)(TagName, { ref: o([elementRef, forwardedRef]), className: clsx_default(className, TransitionGroup_default.TransitionGroupChild), "data-transition-id": transitionId, style, "data-entering": state.enter ? "" : void 0, "data-entering-active": state.enterActive ? "" : void 0, "data-exiting": state.exit ? "" : void 0, "data-exiting-active": state.exitActive ? "" : void 0, "data-interrupted": state.interrupted ? "" : void 0, children });
};
var TransitionGroupChild = (props) => {
  ...
  const [mounted, setMounted] = (0, import_react10.useState)(mountDelay == null);
  useTimeout(() => setMounted(true), mounted ? null : mountDelay);
  return mounted ? (0, import_jsx_runtime751.jsx)(TransitionGroupChildInner, { ...props }) : null;
};
var TransitionGroup = (props) => {
  ...
  const createDefaultRenderChildProps = (0, import_react10.useCallback)((child) => ({
    component: child,
    shouldRender: true,
    removeChild: () => {
  ...
  const [renderChildren, setRenderChildren] = (0, import_react10.useState)(() => {
  ...
  assertSingleChildWhenRef("TransitionGroup", forwardedRef, import_react10.Children.count(children));
  if (disableAnimations) {
    return (0, import_jsx_runtime751.jsx)(import_jsx_runtime751.Fragment, { children: import_react10.Children.map(children, (child) => (0, import_jsx_runtime751.jsx)(
      TagName,
      {
  ...
  return (0, import_jsx_runtime751.jsx)(import_jsx_runtime751.Fragment, { children: renderChildren.map(({ component, ...restProps }) => (0, import_jsx_runtime751.jsx)(TransitionGroupChild, { ...restProps, as: TagName, className, transitionId, enterDuration, exitDuration, enterMountDelay, style, ref: forwardedRef, children: component }, component.key)) });
};
...
var Button = (props) => {
  ...
  return (0, import_jsx_runtime752.jsxs)("button", {
    type,
    ...
    onClick: handleClick,
    ...restProps,
    children: [(0, import_jsx_runtime752.jsx)(TransitionGroup, { className: Button_default.ButtonLoader, enterDuration: 250, exitDuration: 150, children: loading && (0, import_jsx_runtime752.jsx)(LoadingIndicator, {}, "loader") }), (0, import_jsx_runtime752.jsx)("span", { className: Button_default.ButtonInner, children: wrapTextNodeSiblings(children) })]
  });
};
...
// node_modules/@openai/apps-sdk-ui/dist/es/components/Textarea/Textarea.js
var import_jsx_runtime758 = __toESM(require_jsx_runtime());
var import_react17 = __toESM(require_react());

// node_modules/@openai/apps-sdk-ui/dist/es/components/Textarea/Textarea.module.css
var Textarea_default = {
  Container: "Textarea_Container",
  Textarea: "Textarea_Textarea",
  "native-autofill-in": "Textarea_native-autofill-in"
};

// node_modules/@openai/apps-sdk-ui/dist/es/components/Textarea/Textarea.js
var Textarea = (props) => {
  const textAreaRef = (0, import_react17.useRef)(null);
  const inputIdSuffix = (0, import_react17.useId)();
  ...
  const autosizeTextarea = (0, import_react17.useCallback)(() => {
    if (!autoResize || !textAreaRef.current || computedMaxRows === void 0)
      return;
  ...
  return (0, import_jsx_runtime758.jsx)("div", { className: clsx_default(Textarea_default.Container, className), "data-variant": variant, "data-size": size, "data-gutter-size": gutterSize, "data-focused": focused, "data-disabled": disabled ? "" : void 0, "data-readonly": readOnly ? "" : void 0, "data-invalid": invalid ? "" : void 0, style: toCssVariables({
    "textarea-min-rows": `${rows}`,
    "textarea-max-rows": `${computedMaxRows}`
  }), children: (0, import_jsx_runtime758.jsx)("textarea", { ...restProps, onChange: (evt) => {
    onChange?.(evt);
    autosizeTextarea();
  }, ref: o([textAreaRef, ref]), id: id || (allowAutofillExtensions ? void 0 : onePasswordPreventionId), className: Textarea_default.Textarea, name, readOnly, disabled, rows, onFocus: (evt) => {
    setFocused(true);
    onFocus?.(evt);
  }, onBlur: (evt) => {
    setFocused(false);
...
function App() {
  console.log("JoAi ChatGPT App: ", window?.openai);
  return /* @__PURE__ */ (0, import_jsx_runtime759.jsxs)("div", { className: "flex flex-col gap-4 p-4 max-w-lg mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_runtime759.jsx)("h1", { className: "text-2xl font-bold", children: "Hello World" }),
    /* @__PURE__ */ (0, import_jsx_runtime759.jsx)(
      Alert,
      {
        actions: /* @__PURE__ */ (0, import_jsx_runtime759.jsx)(Button, { color: "primary", pill: true, variant: "soft", children: "Dismiss" }),
        title: "Hello World",
        description: "This app is in progress."
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime759.jsx)("span", { children: "nice!" }),
    /* @__PURE__ */ (0, import_jsx_runtime759.jsx)("p", { children: "some example text" }),
    /* @__PURE__ */ (0, import_jsx_runtime759.jsx)(Textarea, { autoResize: true, placeholder: "Enter text...", rows: 3 })
  ] });
}
var rootElement = document.getElementById("root");
if (rootElement) {
  import_client.default.createRoot(rootElement).render(
    /* @__PURE__ */ (0, import_jsx_runtime759.jsx)(import_react18.default.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime759.jsx)(App, {}) })
  );
}
