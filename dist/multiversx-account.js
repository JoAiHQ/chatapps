...
var Badge = ({ children, className, variant = "soft", color = "secondary", size: size4 = "sm", pill, ...restMaybeAsChildProps }) => {
  return (0, import_jsx_runtime2.jsx)("div", { className: clsx_default(Badge_default.Badge, className), "data-color": color, "data-size": size4, "data-pill": pill ? "" : void 0, "data-variant": variant, ...restMaybeAsChildProps, children: wrapTextNodeSiblings(children) });
};
...
var EmptyMessage = ({ children, className, fill = "static" }) => {
  return (0, import_jsx_runtime3.jsx)("div", { className: clsx_default(EmptyMessage_default.EmptyMessage, className), "data-fill": fill, children });
};
var Icon = ({ size: size4 = "md", color = "secondary", children, className }) => {
  return (0, import_jsx_runtime3.jsx)("div", { className: clsx_default(EmptyMessage_default.IconBadge, className), "data-size": size4, "data-color": color, children });
};
var Title = ({ children, className, color = "secondary" }) => {
  return (0, import_jsx_runtime3.jsx)("div", { className: clsx_default(EmptyMessage_default.Title, className), "data-color": color, children });
};
var Description = ({ children, className }) => {
  return (0, import_jsx_runtime3.jsx)("div", { className: clsx_default(EmptyMessage_default.Description, className), children });
};
var ActionRow = ({ children, className }) => {
  return (0, import_jsx_runtime3.jsx)("div", { className: clsx_default(EmptyMessage_default.ActionRow, className), children });
};
...
// node_modules/@radix-ui/react-slot/dist/index.mjs
var import_jsx_runtime749 = __toESM(require_jsx_runtime(), 1);
// @__NO_SIDE_EFFECTS__
function createSlot(ownerName) {
  ...
  const Slot2 = React2.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime749.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React2.isValidElement(newElement) ? React2.cloneElement(newElement, void 0, newChildren) : null });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime749.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
...
function createSlottable(ownerName) {
  const Slottable22 = ({ children }) => {
    return /* @__PURE__ */ (0, import_jsx_runtime749.jsx)(import_jsx_runtime749.Fragment, { children });
  };
...
// node_modules/@radix-ui/react-primitive/dist/index.mjs
var import_jsx_runtime750 = __toESM(require_jsx_runtime(), 1);
var NODES = [
  "a",
  "button",
  "div",
...
var Primitive = NODES.reduce((primitive, node) => {
  ...
  const Node2 = React3.forwardRef((props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime750.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
...
// node_modules/@radix-ui/react-visually-hidden/dist/index.mjs
var import_jsx_runtime751 = __toESM(require_jsx_runtime(), 1);
...
var VisuallyHidden = React4.forwardRef(
  (props, forwardedRef) => {
    return /* @__PURE__ */ (0, import_jsx_runtime751.jsx)(
      Primitive.span,
      {
        ...props,
        ref: forwardedRef,
...
var import_jsx_runtime752 = __toESM(require_jsx_runtime(), 1);
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext3(rootComponentName, defaultContext) {
    ...
    const Provider2 = (props) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime752.jsx)(Context.Provider, { value, children });
    };
...
// node_modules/@radix-ui/react-dismissable-layer/dist/index.mjs
var import_jsx_runtime753 = __toESM(require_jsx_runtime(), 1);
...
var DismissableLayer = React12.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime753.jsx)(
      Primitive.div,
      {
        ...layerProps,
        ref: composedRefs,
...
var DismissableLayerBranch = React12.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime753.jsx)(Primitive.div, { ...props, ref: composedRefs });
});
...
var import_jsx_runtime754 = __toESM(require_jsx_runtime(), 1);
...
var Portal = React13.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom.default.createPortal(/* @__PURE__ */ (0, import_jsx_runtime754.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var import_jsx_runtime755 = __toESM(require_jsx_runtime(), 1);
var NAME2 = "Arrow";
var Arrow = React16.forwardRef((props, forwardedRef) => {
  const { children, width = 10, height = 5, ...arrowProps } = props;
  return /* @__PURE__ */ (0, import_jsx_runtime755.jsx)(
    Primitive.svg,
    {
      ...arrowProps,
      ref: forwardedRef,
      ...
      children: props.asChild ? children : /* @__PURE__ */ (0, import_jsx_runtime755.jsx)("polygon", { points: "0,0 30,0 15,10" })
    }
  );
});
...
// node_modules/@radix-ui/react-popper/dist/index.mjs
var import_jsx_runtime756 = __toESM(require_jsx_runtime(), 1);
...
var Popper = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime756.jsx)(PopperProvider, { scope: __scopePopper, anchor, onAnchorChange: setAnchor, children });
};
...
var PopperAnchor = React17.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : /* @__PURE__ */ (0, import_jsx_runtime756.jsx)(Primitive.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var PopperContent = React17.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime756.jsx)(
      "div",
      {
        ...
        dir: props.dir,
        children: /* @__PURE__ */ (0, import_jsx_runtime756.jsx)(
...
var PopperArrow = React17.forwardRef(function PopperArrow2(props, forwardedRef) {
  ...
  return (
    ...
    /* @__PURE__ */ (0, import_jsx_runtime756.jsx)(
      "span",
      {
...
var import_jsx_runtime757 = __toESM(require_jsx_runtime(), 1);
...
var TooltipProvider = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(
...
var Tooltip = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(Root22, { ...popperScope, children: /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(
...
var TooltipTrigger = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(Anchor, { asChild: true, ...popperScope, children: /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(
      Primitive.button,
      {
...
var TooltipPortal = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(PortalProvider, { scope: __scopeTooltip, forceMount, children: /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var TooltipContent = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React18.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(
      DismissableLayer,
      {
        ...
        onDismiss: onClose,
        children: /* @__PURE__ */ (0, import_jsx_runtime757.jsxs)(
          Content,
          {
            "data-state": context.stateAttribute,
            ...popperScope,
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(Slottable2, { children }),
              /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(Root, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : /* @__PURE__ */ (0, import_jsx_runtime757.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var Tooltip2 = (props) => {
  ...
  const [temporarilyPreventClickToClose, setTemporarilyPreventClickToClose] = (0, import_react9.useState)(false);
  ...
  return (0, import_jsx_runtime758.jsxs)(Root4, { open, delayDuration: openDelay, onOpenChange: handleOpenChange, disableHoverableContent: !interactive, children: [(0, import_jsx_runtime758.jsx)(dist_exports3.Trigger, { asChild: true, children: (0, import_jsx_runtime758.jsx)(dist_exports.Root, { ...restProps, ref: forwardedRef, onPointerDown: (evt) => {
    maybePreventClickClose(evt);
    onPointerDown?.(evt);
  }, onClick: (evt) => {
    maybePreventClickClose(evt);
    onClick?.(evt);
  }, children }) }), (0, import_jsx_runtime758.jsx)(Content3, { maxWidth, compact, align, alignOffset, side, sideOffset, gutterSize, className: contentClassName, children: content })] });
};
var Root4 = ({ children, open, onOpenChange, ...restProps }) => {
  useEscCloseStack(open, () => {
    onOpenChange(false);
  });
  return (0, import_jsx_runtime758.jsx)(dist_exports3.Provider, { children: (0, import_jsx_runtime758.jsx)(dist_exports3.Root, { open, onOpenChange, ...restProps, children }) });
};
...
var TriggerDecorator = (props) => {
  ...
  return (0, import_jsx_runtime758.jsx)(dist_exports.Root, { ref, ...restProps, className: clsx_default(Tooltip_default.TriggerDecorator, className), tabIndex: focusable ? 0 : void 0, children: isPlainText ? (0, import_jsx_runtime758.jsx)("span", { children }) : children });
};
Tooltip2.Root = Root4;
...
// src/apps/multiversx-account/index.tsx
...
function useOpenAiGlobal(key) {
  const onChangeRef = (0, import_react11.useRef)(null);
...
// src/apps/multiversx-account/helpers.ts
...
function App() {
  ...
  if (!toolData || !toolData.ACCOUNT_DATA) {
    return /* @__PURE__ */ (0, import_jsx_runtime760.jsxs)(EmptyMessage, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime760.jsx)(EmptyMessage.Title, { children: "No account data" }),
      /* @__PURE__ */ (0, import_jsx_runtime760.jsx)(EmptyMessage.Description, { children: "Account information is not available." })
    ] });
  }
  const { ACCOUNT_DATA, BALANCE_FORMATTED, NONCE, USERNAME } = toolData;
  return /* @__PURE__ */ (0, import_jsx_runtime760.jsxs)("div", { className: "flex flex-col gap-4 p-4 max-w-lg mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_runtime760.jsxs)("div", { className: "text-center", children: [
      /* @__PURE__ */ (0, import_jsx_runtime760.jsx)("h1", { className: "heading-lg", children: "MultiversX Account" }),
      /* @__PURE__ */ (0, import_jsx_runtime760.jsx)(Tooltip2, { content: ACCOUNT_DATA.address, children: /* @__PURE__ */ (0, import_jsx_runtime760.jsx)("p", { className: "font-mono text-sm text-secondary mt-1 cursor-help", children: shortenAddress(ACCOUNT_DATA.address) }) }),
      USERNAME && /* @__PURE__ */ (0, import_jsx_runtime760.jsxs)(Badge, { color: "info", className: "mt-2", children: [
        "@",
        USERNAME
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime760.jsx)("div", { className: "rounded-2xl border border-default bg-surface p-4", children: /* @__PURE__ */ (0, import_jsx_runtime760.jsxs)("dl", { className: "space-y-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime760.jsxs)("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime760.jsxs)("dt", { className: "flex items-center gap-2 text-secondary", children: [
          /* @__PURE__ */ (0, import_jsx_runtime760.jsx)(DollarCircle_default, { className: "size-5" }),
          "Balance"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime760.jsxs)("dd", { className: "text-xl font-bold text-primary", children: [
          BALANCE_FORMATTED,
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime760.jsx)("span", { className: "text-sm text-secondary", children: "EGLD" })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime760.jsxs)("div", { className: "flex items-center justify-between border-t border-subtle pt-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime760.jsxs)("dt", { className: "flex items-center gap-2 text-secondary", children: [
          /* @__PURE__ */ (0, import_jsx_runtime760.jsx)(Number_default, { className: "size-5" }),
          "Nonce"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime760.jsx)("dd", { className: "font-medium", children: NONCE.toLocaleString() })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime760.jsxs)("div", { className: "flex items-center justify-between border-t border-subtle pt-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime760.jsxs)("dt", { className: "flex items-center gap-2 text-secondary", children: [
          /* @__PURE__ */ (0, import_jsx_runtime760.jsx)(AvatarProfile_default, { className: "size-5" }),
          "Shard"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime760.jsx)("dd", { className: "font-medium", children: ACCOUNT_DATA.shard })
      ] })
    ] }) })
  ] });
}
...
if (rootElement) {
  import_client.default.createRoot(rootElement).render(
    /* @__PURE__ */ (0, import_jsx_runtime760.jsx)(import_react13.default.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime760.jsx)(App, {}) })
  );
}
